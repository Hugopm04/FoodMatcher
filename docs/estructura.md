...
Únicamente para contener la descripción del problema, del proyecto y enlaces a documentos que demuestren que el objetivo a sido mejorado. [README](../README.md)
...
## Img
Directorio para almacenar todas las imágenes que se vayan a usar para documentación.
